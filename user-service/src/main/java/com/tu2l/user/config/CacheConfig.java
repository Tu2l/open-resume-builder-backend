...
/**
 * Enables in-process Caffeine caching. The {@code users} cache holds lightweight
 * user lookups (see {@code UserServiceImpl.getUserByUsername}) with a short TTL;
 * mutations evict the relevant entries. Suitable for a single-instance deployment.
 */
@Configuration
@EnableCaching
